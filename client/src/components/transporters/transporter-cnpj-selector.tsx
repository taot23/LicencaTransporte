...
export function TransporterCnpjSelector({ transporterId, onCnpjSelect }: TransporterCnpjSelectorProps) {
              ...
              <div className="flex items-center space-x-2 w-full">
                ...
                <div className="flex-1">
                  <div className="font-medium text-sm">
                    {option.type === 'matriz' ? '(Matriz)' : '(Filial)'} {option.label.split(' - ')[0]}
                  </div>
      ...
      {selectedCnpj && (
        <div className="mt-2 text-xs text-gray-600">
          <div className="bg-blue-50 p-2 rounded border border-blue-200">
            <span className="font-medium">CNPJ Selecionado:</span> {selectedCnpj}
          </div>
        </div>
      )}
